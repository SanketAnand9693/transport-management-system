...
if (vehicleNumber != null && !vehicleNumber.trim().isEmpty()) {
	...
	try {
		...
		PreparedStatement changeDriverToVehicleStatus = con.prepareStatement("DELETE FROM driver_to_vehicle WHERE vehicle_number = ?;");
		changeDriverToVehicleStatus.setString(1, vehicleNumber);
		...
		"INSERT INTO maintenance(vehicle_number, problems, cost, created_on, created_by) VALUES(?,?,?,?,?)");

		pst.setString(1, vehicleNumber);
		pst.setString(2, request.getParameter("problems"));
		pst.setString(3, request.getParameter("cost"));
		pst.setDate(4, createdOn);
